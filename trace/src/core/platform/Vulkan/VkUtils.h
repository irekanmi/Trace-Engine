...
namespace vk {
	...
	bool _ReadImageData(trace::VKHandle* instance, trace::VKDeviceHandle* device, trace::VKImage* image, trace::TextureDesc& desc, glm::ivec3 offset, glm::uvec3 extent, void*& out_data, trace::VKCommmandBuffer& cmd_buf, trace::VKBuffer& staging_buffer, bool read_immediate = true);
