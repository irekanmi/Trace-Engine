...
namespace trace {
	...
	typedef bool (*__DrawInstanced)(GDevice*,uint32_t, uint32_t, uint32_t);
	typedef bool (*__DrawIndexed)(GDevice*,uint32_t, uint32_t);
	typedef bool (*__DrawIndexedInstanced)(GDevice*,uint32_t, uint32_t, uint32_t);
	...
	public:
		...
		static bool DrawInstanced(GDevice* device, uint32_t start_vertex, uint32_t count, uint32_t num_instances);
		static bool DrawIndexed(GDevice* device, uint32_t first_index, uint32_t count);
		static bool DrawIndexedInstanced(GDevice* device, uint32_t first_index, uint32_t count, uint32_t num_instances);
	...
	private:
		...
		static __Draw _draw;
		static __DrawInstanced _drawInstanced;
		static __DrawIndexed _drawIndexed;
		static __DrawIndexedInstanced _drawIndexedInstanced;
