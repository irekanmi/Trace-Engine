...
namespace ImGui
{
    ...
    static void processCurrentFrame(FrameIndexType* frame, ImGuiNeoSequencerInternalData& context)
    {
        ...
        bool hovered = ItemHoverable(pointerRect, GetCurrentWindow()->GetID("##_top_selector_neo"), ImGuiItemFlags_::ImGuiItemFlags_None);
    ...
    static bool createKeyframe(int32_t* frame)
    {
        ...
        bool hovered = ItemHoverable(bb, id, ImGuiItemFlags_::ImGuiItemFlags_None);
...
//
        ...
        *end = endFrameVal;
        ...
        bool hovered = ItemHoverable(bb, GetCurrentWindow()->GetID("##zoom_slider"), ImGuiItemFlags_::ImGuiItemFlags_None);
